...
<link rel="stylesheet" type="text/css"
	href="resources/css/bootstrap4moving.css">
<link rel="stylesheet" type="text/css"
	href="resources/css/stylefoot.css">
<link rel="stylesheet" type="text/css"
...
<nav
	...
	<div class="container">
		...
		<center>
			<h2
				style="color: #1E70C8; font-size: 40px; font-weight: bolder; font-family: rk; position: absolute; top: 10%;; right: 40%;">Registration
				Page</h2>
		</center>
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link"
						href="CreatePool.jsp"><b>Home</b> <span class="sr-only">(current)</span>
					</a></li>
				</ul>
			</div>
		</div>
